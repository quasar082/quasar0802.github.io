...
export function HomePreloader({ heroImagePath }: HomePreloaderProps) {
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-[9999] grid place-items-center overflow-hidden bg-white text-[#111] [animation:home-preloader-exit_520ms_ease-in-out_2700ms_forwards] motion-reduce:hidden" aria-hidden="true">
      ...
      <div ref={stageRef} style={preloaderVars} className="relative flex h-screen w-screen items-center justify-center px-6 [--image-scale:0.16] [--left-split:0px] [--right-split:0px] [--title-size:4dvw] sm:[--image-scale:0.13] sm:[--title-size:2.8dvw] lg:[--image-scale:0.15] lg:[--title-size:2.35dvw] xl:[--image-scale:0.17] xl:[--title-size:3.8dvw] 2xl:[--image-scale:0.2] 2xl:[--title-size:4.4dvw]">
