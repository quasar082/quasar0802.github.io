...
export function HomePreloader({ heroImagePath }: HomePreloaderProps) {
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-[9999] grid place-items-center overflow-hidden bg-white text-[#111] [animation:home-preloader-exit_520ms_ease-in-out_2700ms_forwards] motion-reduce:hidden" aria-hidden="true">
      ...
      <div ref={stageRef} style={preloaderVars} className="relative flex h-screen w-screen items-center justify-center px-6 [--image-scale:0.26] [--left-split:0px] [--right-split:0px] [--title-size:clamp(1rem,7vw,2rem)] sm:[--image-scale:0.2] sm:[--title-size:clamp(1.35rem,4.8vw,3.5rem)] lg:[--image-scale:0.22] lg:[--title-size:clamp(1.6rem,4.1vw,4.4rem)] xl:[--title-size:clamp(2.1rem,5.8vw,6.5rem)] 2xl:[--title-size:clamp(2.4rem,6.2vw,7.2rem)]">
