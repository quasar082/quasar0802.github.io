...
export function HomePreloader({ heroImagePath }: HomePreloaderProps) {
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-[9999] grid place-items-center overflow-hidden bg-white text-[#111] [animation:home-preloader-exit_520ms_ease-in-out_2700ms_forwards] motion-reduce:hidden" aria-hidden="true">
      ...
      <div ref={stageRef} style={preloaderVars} className="relative flex h-screen w-screen items-center justify-center px-6 [--image-scale:0.2] [--left-split:0px] [--right-split:0px] [--title-size:clamp(0.9rem,6vw,1.7rem)] sm:[--image-scale:0.16] sm:[--title-size:clamp(1.15rem,4.1vw,2.8rem)] lg:[--image-scale:0.18] lg:[--title-size:clamp(1.35rem,3.5vw,3.7rem)] xl:[--image-scale:0.2] xl:[--title-size:clamp(1.9rem,5.2vw,6rem)] 2xl:[--image-scale:0.22] 2xl:[--title-size:clamp(2.2rem,5.8vw,6.8rem)]">
