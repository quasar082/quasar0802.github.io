...
export function HomePreloader({ heroImagePath }: HomePreloaderProps) {
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-[9999] grid place-items-center overflow-hidden bg-white text-[#111] [animation:home-preloader-exit_520ms_ease-in-out_2700ms_forwards] motion-reduce:hidden" aria-hidden="true">
      ...
      <div ref={stageRef} style={preloaderVars} className="relative flex h-screen w-screen items-center justify-center px-6 [--image-scale:0.2] [--left-split:0px] [--right-split:0px] [--title-size:4.8dvw] sm:[--image-scale:0.16] sm:[--title-size:3.3dvw] lg:[--image-scale:0.18] lg:[--title-size:2.8dvw] xl:[--image-scale:0.2] xl:[--title-size:4.4dvw] 2xl:[--image-scale:0.22] 2xl:[--title-size:5dvw]">
