        ...
        <div
          ...
          style={
            isMobile
              ? undefined
              : ({
                  '--image-start-transform': `translate3d(calc(-25% + ${inlineOffset.x}px), calc(-50% + ${inlineOffset.y}px), 0) scale(var(--image-scale))`,
                  '--image-end-transform': 'translate3d(-25%, -50%, 0) scale(1)',
